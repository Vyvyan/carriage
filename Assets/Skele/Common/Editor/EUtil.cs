...
#if UNITY_5 && (UNITY_5_1 || UNITY_5_2 || UNITY_5_3 || UNITY_5_3_OR_NEWER )
#define U5_1_ABOVE
#endif
...
#else //U4
        public static UnityEditorInternal.AnimatorController GetAnimatorController(Animator ator)
        {
            var acontrol = ator.runtimeAnimatorController as UnityEditorInternal.AnimatorController; 
            Dbg.Assert(acontrol != null, "EUtil.GetAnimatorController failed");
            return acontrol;
        }
#endif
